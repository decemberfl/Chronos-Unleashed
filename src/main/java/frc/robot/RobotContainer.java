...
*/
  ...
  public static void printDiagnostics(){
    /*SmartDashboard.putBoolean("NavX Connected?", Swerve.getInstance().getNavxConnected());
  ...
  private void configureButtonBindings() {
    ...
    //   .onFalse(new InstantCommand(() -> ClimbSubsystem.getInstance().leftClimbPower(0)));
    // dpadRight.onTrue(new InstantCommand(() -> ClimbSubsystem.getInstance().rightClimbPower(climbUp)))
    //   .onFalse(new InstantCommand(() -> ClimbSubsystem.getInstance().rightClimbPower(0)));
    // dpadUpRight.onTrue(new InstantCommand(() -> ClimbSubsystem.getInstance().leftClimbPower(climbUp)))
    //   .onTrue(new InstantCommand(() -> ClimbSubsystem.getInstance().rightClimbPower(climbUp)))
    //   .onFalse(new InstantCommand(() -> ClimbSubsystem.getInstance().leftClimbPower(0)))
    //   .onFalse(new InstantCommand(() -> ClimbSubsystem.getInstance().rightClimbPower(0)));   

    // dpadDown.onTrue(new InstantCommand(() -> ClimbSubsystem.getInstance().leftClimbPower(climbDown)))
    //   .onTrue(new InstantCommand(() -> ClimbSubsystem.getInstance().rightClimbPower(climbDown)))
    //   .onFalse(new InstantCommand(() -> ClimbSubsystem.getInstance().leftClimbPower(0)))
    //   .onFalse(new InstantCommand(() -> ClimbSubsystem.getInstance().rightClimbPower(0)));   
    ...
    //driver.getAButton().onTrue(new InstantCommand(() -> IndexerSubsystem.getInstance().automaticIntaking()));
    ...
    Trigger leftTriggerAxis = new Trigger(() -> { return driver.getLeftTriggerAxis() > triggerDeadzone;});
    Trigger rightTriggerAxis = new Trigger(() -> { return driver.getRightTriggerAxis() > triggerDeadzone;});
  ...
  //  .onFalse(new InstantCommand(() -> PivotSubsystem.getInstance().retractIntake()));
  ...
  //   dpadRight2.onTrue(new InstantCommand(() -> m_indexerSubsystem.useColorSort = true));
  //   dpadLeft2.onTrue(new InstantCommand(() -> m_indexerSubsystem.useColorSort = false));

  //   dpadDown2.onTrue(new InstantCommand(() ->m_pivotSubsystem.getInstance().resetIntakeDown()));
  //   dpadUp2.onTrue(new InstantCommand(() ->m_pivotSubsystem.getInstance().resetIntakeUp()));
  ...
  //   Trigger leftTriggerAxis2 = new Trigger(() -> { return driver2.getLeftTriggerAxis() > triggerDeadzone;});
  //   Trigger rightTriggerAxis2 = new Trigger(() -> { return driver2.getRightTriggerAxis() > triggerDeadzone;});
  ...
  //   //driver2.getRightBumper().whenPressed(new SetIndexerCommand(indexerUp,true));
                     
  //   leftTriggerAxis2.whileActiveContinuous(new InstantCommand(() -> ClimbSubsystem.getInstance().leftPivotPower(pivotDown*driver2.getLeftTriggerAxis())))
  //     .onFalse(new InstantCommand(() -> ClimbSubsystem.getInstance().leftPivotPower(0)));
  //   rightTriggerAxis2.whileActiveContinuous(new InstantCommand(() -> ClimbSubsystem.getInstance().rightPivotPower(pivotDown*driver2.getRightTriggerAxis())))
  //     .onFalse(new InstantCommand(() -> ClimbSubsystem.getInstance().rightPivotPower(0)));                    
                    
  //   Trigger leftJoyStick = new Trigger(() -> { return Math.abs(driver2.getLeftY()) > triggerDeadzone;});
  //   Trigger rightJoystick = new Trigger(() -> { return Math.abs(driver2.getRightY()) > triggerDeadzone;});
  //   leftJoyStick.whileActiveContinuous(new InstantCommand(() -> ClimbSubsystem.getInstance().leftClimbPower(-climbUp*driver2.getLeftY())))
  //     .onFalse(new InstantCommand(() -> ClimbSubsystem.getInstance().leftClimbPower(0)));
  //   rightJoystick.whileActiveContinuous(new InstantCommand(() -> ClimbSubsystem.getInstance().rightClimbPower(-climbUp*driver2.getRightY())))
  //     .onFalse(new InstantCommand(() -> ClimbSubsystem.getInstance().rightClimbPower(0)));

    
  //   //driver2.getXButton().whenHeld(new SetIntakeCommand(intakeOn)).whenReleased(new SetIntakeCommand(0.0));
  //   driver2.getBButton().whenHeld(new SetIntakeCommand(0)).whenReleased(new InstantCommand(() -> IndexerSubsystem.getInstance().automaticIntaking()));
  //  driver2.getAButton().onTrue(new InstantCommand(() -> PivotSubsystem.getInstance().deployIntake()))
  //   .onTrue(new InstantCommand(() -> IndexerSubsystem.getInstance().automaticIntaking()))
  //   //.onFalse(new SetIntakeCommand(0))  
  //   .onFalse(new InstantCommand(() -> PivotSubsystem.getInstance().retractIntake()));
